...
export class DataService {
  ...
  timelines = timelines;
  projects = projects;
  projectsByKey = new Map<string, ProjectInterface>();
  ...
  private setProjectByDate() {
    this.projects.forEach((project) => {
      this.projectsByDate.set(project.dateKey, { ...project });
    });
  }
